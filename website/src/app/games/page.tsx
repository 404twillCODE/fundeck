        ...
        <Container>
          <div className="max-w-3xl space-y-6">
            ...
            <p className="text-lg text-white/60">
              FunDeck is your private game hub — quick party games, debate chaos, and casino
              classics built for voice chat and game nights.
            </p>
          </div>
        </Container>
      </section>
              ...
              <div className="flex flex-wrap gap-2">
                {searchCategories.map((category) => {
                  ...
                  const isActive =
                    category === "All"
                      ? searchQuery.trim() === ""
                      : searchQuery.trim().toLowerCase() === category.toLowerCase();
